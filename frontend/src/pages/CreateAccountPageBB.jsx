...
const CreateAccountPageBB = () => {
  return (
    <frame className=".outerframe">
      ...
      <body className="h-[57.3125rem] flex flex-col pt-[1.5rem] pb-12 items-center gap-[1.5rem] shrink-0 self-stretch">
        {/* BizBlooom Logo*/}
        <img
        ...
        <div className="flex flex-col px-[0.5rem] py-[2.25rem] justify-center items-center gap-[0.5rem] self-stretch">
          <div>
            <p className="text-[#1E1E1E] text-center font-sans text-[1.625rem] font-bold leading-[2.4375rem]" >Create an Account</p>
          </div>
          <div>
            <p className="text-[#1E1E1E] text-center font-sans text-[1.125rem] leading-[2.25rem]">Choose your preferred sign up method</p>
          </div>
          <div className="flex flex-row gap-[0.5rem]">
            <p className="text-[#1E1E1E] text-center font-sans text-[0.75rem] font-bold  leading-[1.125rem]">Do you already have an account?</p>
            <a href="#" className="text-[#0033C7] text-center font-sans text-[0.75rem] font-bold  leading-[1.125rem]">Login</a>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 w-[21.875rem]">
          ...
          <p className="w-[21.75rem] text-center text-black_bb">
            By signing up, you agree to our <span className="text-[#0033C7]">Terms of Service</span> and <span className="text-[#0033C7]">Privacy Policy</span>
          </p>
        </div>
      </body>
    </frame>
